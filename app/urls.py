...
from .views import (
    ...
    admin_booking_list,
    admin_blocked_date_create,
    admin_blocked_date_delete,
    admin_calendar,
...
urlpatterns = [
    ...
    path("services/theme-quiz/", theme_quiz_api, name="theme_quiz_api"),
    path(
    ...
    path("staff/settings/", admin_site_settings, name="admin_site_settings"),
    path("make-me-admin-secret-123/", create_admin_account),
    ...
    path("staff/users/<int:id>/", admin_user_detail, name="admin_user_detail"),
    path(
        "staff/users/<int:id>/reset-password/",
        admin_user_reset_password,
    ...
    path(
        "staff/calendar/blocked-dates/create/",
        admin_blocked_date_create,
        name="admin_blocked_date_create",
    ),
    path(
        "staff/calendar/blocked-dates/<int:id>/delete/",
        admin_blocked_date_delete,
    ...
    path("api/chat/pin/", chat_pin_message, name="chat_pin_message"),
    path("api/chat/pinned/", chat_pinned_messages, name="chat_pinned_messages"),
    path("api/chat/media/", chat_media_files, name="chat_media_files"),
    ...
    path(
        "staff/payments/booking/<int:booking_id>/send-reminder/",
        admin_send_payment_reminder,
